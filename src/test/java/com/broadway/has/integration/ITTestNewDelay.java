...
@ContextConfiguration(initializers = {ITTestNewDelay.Initializer.class})
...
public class ITTestNewDelay {
    ...
    @Test
    public void TestSchedulingDelayWatering() throws Exception{
        ...
        TestUtils.delayWatering(timestamp, 3600000, 3, this.getClass().getName(), scheduler);
